    ...
    <div className="max-w-md mx-auto bg-card text-card-foreground p-5 rounded-lg ">
              ...
              <div className="flex justify-around space-x-4">
                ...
                <FaBrain className='text-lg text-[#ff11ae]'/>
                  ...
                  <span className="ml-2 text-[11px]">Experiences:<br/> <span className='text-[#2f24ff] font-semibold'> 2 Years</span></span>
                </div>
                <div className="flex items-center bg-gray-100 p-2 rounded-sm">
                <IoStar  className='text-lg text-[#ffa42d]' />
                <span className="ml-2 text-[11px]">Rating:<br/> <span className='text-[#2f24ff] font-semibold'> 4.8/5.0</span></span>
                </div>
                <div className="flex items-center bg-gray-100 p-2 rounded-sm">
                <MdPeopleAlt  className='text-lg text-[#5111ff]' />
                <span className="ml-2 text-[11px]">Patients:<br/> <span className='text-[#2f24ff] font-semibold'> 75+ </span></span>
                </div>
              </div>
              ...
              <Link to='/shadule' className="bg-[#db2b6a] text-white p-3 rounded-lg  text-center w-[100%]">
            Make Appointment
          </Link>
          </div>
            </div>
