  ...
  return (
    ...
    <Link className='absolute top-4 left-4 z-40' to='/doctordetail'><IoArrowBack className="text-white text-xl" /></Link>
        ...
        <div className="w-[60%] flex flex-col justify-start z-10 p-4">
          ...
          <p className='text-[12px] py-2 text-[#ffffff]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime corporis, voluptates ex sit consequatur illum et magnam voluptatem modi, impedit quis earum inventore perferendis non similique saepe provident? Incidunt, velit!</p>
        </div>
    </div>
    ...
    <h3 className="text-[16px] font-bold mt-2">Notes</h3>
              <p className="text-[12px] text-justify text-gray-500  border p-2 mb-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non enim praesent elementum Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta quae doloribus amet est necessitatibus, velit blanditiis laborum ut dolorem cupiditate rerum id aspernatur architecto dignissimos. Tempora sequi maxime aliquam dignissimos.
                facilisis leo, vel.
              </p>
    </div>
    <div className="flex w-full p-4">
              ...
              <Link to='/home' className="bg-[#db2b6a] text-white p-3 rounded-lg  text-center w-[100%]">
            Make Appointment
          </Link>
          </div>
            </div>
