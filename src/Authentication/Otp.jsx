...
export const Otp = () => {
  return (
    ...
    <div>
      ...
      <p className="text-sm text-center font-[500] absolute bottom-3 left-1/2 transform -translate-x-1/2 w-full">Did not recived code? <span className="text-[#37C2C1] font-semibold"><Link to="/login">Resend.</Link></span></p>
    </div>
  )
}
