      ...
      <div className="w-full bg-[#fafafa] overflow-hidden">
        <div className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <h1 className="text-lg font-semibold text-center flex-grow">Digestion</h1>
        ...
        <div key={index} className="card bg-white p-4 mb-4">
          ...
          <div className='flex gap-1 items-center'>
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">{test.parameters} Parameters Covered</p>
            </div>
            </div>
            
            <div className="text-base font-bold text-gray-700">₹{test.price.toFixed(2)}</div>
          </div>
          <div className="flex justify-between items-center mt-4">
            <div className="flex gap-2 w-full ">
              <Link to='/doctordetail' className="border w-1/2 text-sm text-center border-blue-500 text-blue-500 px-4 py-1 rounded-full hover:bg-blue-100">
             
                DETAILS
              </Link>
              <Link to='/shadule' className="bg-blue-500 w-1/2 text-center text-sm text-white px-4 py-1 rounded-full hover:bg-blue-600">
                BOOK NOW
              </Link>
            </div>
          </div>
