    ...
    <div className="max-w-md mx-auto h-[100vh] flex flex-col justify-between shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-4 mt-4">
           <Link to='/mainhome'> <IoArrowBack className="text-gray-600 text-xl" /></Link>
            <h1 className="text-lg font-semibold text-center flex-grow">Doctor Detail</h1>
        ...
        <div className="flex items-center flex-col justify-center">
          ...
          <div className="flex-grow text-center">
            ...
            <div className="flex items-center mt-1">
              ...
              <span className="ml-2 text-sm text-gray-600">4.8 (129 reviews)</span>
            </div>
          </div>
        </div>
        <div className='flex gap-2 items-center my-4'>
        <Link to='/chat' className="w-full text-center bg-white border border-blue-600 text-blue-600 py-1 rounded-full font-medium">
          CONTACT LABS
        </Link>
